...
import {
    ...
    RestActionResponseFromJSON,
    RestActionResponseToJSON,
...
export interface ControlActionJobRequest {
    name: ControlActionJobNameEnum;
    jobUuid: string;
...
export interface GetActionJobRequest {
    name: GetActionJobNameEnum;
    jobUuid: string;
...
export class NodeServiceApi extends runtime.BaseAPI {
     ...
     */
    async controlActionJobRaw(requestParameters: ControlActionJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBackgroundJobResult>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling controlActionJob().'
            );
        }
        ...
        if (requestParameters['jobUuid'] == null) {
            throw new runtime.RequiredError(
                'jobUuid',
                'Required parameter "jobUuid" was null or undefined when calling controlActionJob().'
            );
        }
        ...
        if (requestParameters['command'] == null) {
            throw new runtime.RequiredError(
                'command',
                'Required parameter "command" was null or undefined when calling controlActionJob().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RestBackgroundJobResultFromJSON(jsonValue));
    }

    /**
     * Send control commands to a background job
     */
    async controlActionJob(requestParameters: ControlActionJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestBackgroundJobResult> {
        const response = await this.controlActionJobRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getActionJobRaw(requestParameters: GetActionJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestBackgroundJobResult>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
                'Required parameter "name" was null or undefined when calling getActionJob().'
            );
        }
        ...
        if (requestParameters['jobUuid'] == null) {
            throw new runtime.RequiredError(
                'jobUuid',
                'Required parameter "jobUuid" was null or undefined when calling getActionJob().'
            );
        }

        const queryParameters: any = {};

        if (requestParameters['parametersTargetNodeUuid'] != null) {
            queryParameters['Parameters.TargetNode.Uuid'] = requestParameters['parametersTargetNodeUuid'];
        }

        if (requestParameters['parametersTargetNodePath'] != null) {
            queryParameters['Parameters.TargetNode.Path'] = requestParameters['parametersTargetNodePath'];
        }

        if (requestParameters['parametersSelectionUuid'] != null) {
            queryParameters['Parameters.SelectionUuid'] = requestParameters['parametersSelectionUuid'];
        }

        if (requestParameters['parametersJsonParameters'] != null) {
            queryParameters['Parameters.JsonParameters'] = requestParameters['parametersJsonParameters'];
        }

        if (requestParameters['parametersAwait'] != null) {
            queryParameters['Parameters.Await'] = requestParameters['parametersAwait'];
        }
     ...
     * Retrieve information about an action running in background
     */
    async getActionJob(requestParameters: GetActionJobRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestBackgroundJobResult> {
        const response = await this.getActionJobRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async performActionRaw(requestParameters: PerformActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RestActionResponse>> {
        if (requestParameters['name'] == null) {
            throw new runtime.RequiredError(
                'name',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RestActionResponseFromJSON(jsonValue));
    }

    /**
     * Trigger an action on the tree. Returns a JobInfo describing a background task.
     */
    async performAction(requestParameters: PerformActionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RestActionResponse> {
 ...
 * @export
 */
export const ControlActionJobNameEnum = {
    Delete: 'delete',
    Restore: 'restore',
    Copy: 'copy',
    Move: 'move',
...
export type ControlActionJobNameEnum = typeof ControlActionJobNameEnum[keyof typeof ControlActionJobNameEnum];
/**
 * @export
 */
export const GetActionJobNameEnum = {
    Delete: 'delete',
    Restore: 'restore',
    Copy: 'copy',
    Move: 'move',
...
export type GetActionJobNameEnum = typeof GetActionJobNameEnum[keyof typeof GetActionJobNameEnum];
/**
 * @export
 */
